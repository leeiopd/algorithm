...
for case in range(1, T+1):
    ...
    peopleTimes = list(map(int, input().split()))
    timeTable = [0] * 11113
    for peopleTime in peopleTimes:
        timeTable[peopleTime] += 1
    ...
    if flag:
        print('#{} Impossible'.format(case))
    else:
        print('#{} Possible'.format(case))
